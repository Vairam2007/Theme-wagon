...
const Home_comp = () => {
  return (
    <div
      className="w-full min-h-[100vh] flex flex-col xl:flex-row justify-center gap-0 md:gap-10 items-center p-[20px]"
      style={{ background: "url('/assets/hero-bg.jpg') no-repeat" ,backgroundSize: "cover" } } 
    >
      <div className="w-full lg:w-[50%] h-[50vh] gap-7 flex-col flex items-center justify-center p-5 md:gap-10" >
        ...
        <div className="flex flex-col sm:flex-row w-[90%] justify-center gap-10">
