...
const Contact_comp = () => {
  return (
    <div className='w-full min-h-[100vh] flex justify-center items-center overflow-x-hidden' style={{background:"url('/assets/contact-bg.jpg')",backgroundSize:"cover"}}>
        <div className="w-[90%] min-h-[90vh] p-[20px] flex flex-col lg:flex-row gap-10 ">
            <div data-aos="fade-right" className="my-[80px] sm:my-0 flex flex-col gap-10 w-full lg:w-[50%] h-[80vh]">
            ...
            <div data-aos="fade-left" className="w-full lg:w-[50%] h-[60vh] overflow-x-hidden relative lg:h-[60vh]  lg:translate-y-[25%] ">
                
                <img data-aos="fade-left" src="/assets/p-1.jpg" className='w-[300px] h-[300px] absolute top-0 left-0 z-0' />
                <img data-aos="fade-right" src="/assets/p-2.jpg" className='w-[300px] h-[300px] absolute bottom-0 right-0 z-1' />
